...
const DefaultLayout = (props: LayoutProps) => {
  ...
  return (
    ...
    >
      <Head>
        <title>Rayna - Autonomous AI Agents in your browser</title>
        <meta name="description" content={description} />
        <meta name="twitter:site" content="@Rayna_com" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Rayna 🤖" />
        ...
        <meta
          property="og:title"
          content="Rayna: Autonomous AI Agents in your browser 🤖"
        />
        ...
        <meta property="og:site_name" content="Rayna" />
